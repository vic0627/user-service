...
/** 服務根節點配置 */
interface ServiceConfigRoot
    extends ServiceFuncConfig,
        Omit<ServiceRequestConfig, "method"> {
    baseURL: string;
    name: string;
    description?: string;
...
/** 服務子節點配置 */
interface ServiceConfigChild
    extends Omit<ServiceConfigRoot, "baseURL" | "name"> {
    route: string;
    name?: string;
}
